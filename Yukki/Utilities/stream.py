...
async def start_stream_audio(
    ...
    if await is_active_chat(message.chat.id):
        ...
        final_output = await message.reply_photo(
            ...
            caption=(
                f"⏩<b> 𝖲𝖾𝗌: </b> [Telegram Üzerinden Ses Verildi]({link})\n⌚<b> 𝖲𝗎𝗋𝖾:</b> {duration_min} \n📒<b> 𝖳𝖺𝗅𝖾𝗉: </b>{message.from_user.mention} \n🚧<b> 𝖪𝗎𝗒𝗋𝗎𝗀𝖺 𝖠𝗅𝗂𝗇𝖽𝗂:</b> <b>#{position}!</b>"
            ),
        ...
        await mystic.delete()
        cap = f"⏩<b> 𝖮𝗒𝗇𝗎𝗒𝗈𝗋: </b>[Telegram Üzerinden Ses Verildi]({link})\n📒**𝖳𝖺𝗅𝖾𝗉:** {message.from_user.mention}"
        final_output = await message.reply_photo(
            photo="Utils/Telegram.JPEG",
            reply_markup=InlineKeyboardMarkup(buttons),
            caption=cap,
